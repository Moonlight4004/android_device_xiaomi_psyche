...
psyche_deps(){
	...
	git_check_dir https://gitlab.com/stuartore/android_vendor_xiaomi_psyche superior-13-unstable vendor/xiaomi/psyche
...
psyche_rom_setup(){
	if [[ -d hardware/xiaomi ]] && [[ -d device/xiaomi/psyche ]] && [[ -d vendor/xiaomi/psyche ]] && [[ -d kernel/xiaomi/void-aosp-sm8250 ]] && [[ -d vendor/xiaomi-firmware/psyche ]];then
		return
	fi
